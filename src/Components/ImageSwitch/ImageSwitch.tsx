...
const ImageSwitch = (props: Props) => {
  const { imageName, imageProperties } = props;
      ...
      case "delete":
        return (
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className={imageProperties.trim() ? imageProperties : "size-6"}
          >
            <path
              strokeLinecap="round"
      ...
      case "arrowLeft":
        return (
          <svg
            ...
            fill="currentColor"
            className={
              imageProperties.trim()
                ? imageProperties
                : "size-6 font-bold   text-xs"
            }
          >
            <path
              fillRule="evenodd"
      ...
      case "moon":
        return (
          <svg
            ...
            viewBox="0 0 16 16"
            fill="currentColor"
            className={imageProperties.trim() ? imageProperties : "size-4"}
          >
        ...
        return (
          <svg
            ...
            className={
              imageProperties.trim()
                ? imageProperties
                : "size-16 md:size-8  text-orange-600 sm:self-center "
            }
          >
            <path
              strokeLinecap="round"
      ...
      case "errorMessage":
        return (
          <svg
            ...
            stroke="currentColor"
            className={
              imageProperties.trim() ? imageProperties : "size-6 text-red-900"
            }
          >
            <path
              strokeLinecap="round"
      ...
      default:
        return (
          <svg
            ...
            stroke="currentColor"
            className={
              imageProperties && imageProperties.trim()
                ? imageProperties
                : "size-6 "
            }
          >
